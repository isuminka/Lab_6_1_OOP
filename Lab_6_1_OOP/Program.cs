...
namespace Lab_6_1_OOP
{
    interface IBook
    {
        void groupByYear(Book[] books);
        void countAmount(Book[] books);
    }
    ...
    class Book : IBook
    {
        ...
        public void groupByYear(Book[] books)
        {
        ...
        public void countAmount(Book[] books)
        {
            Console.WriteLine("+------+-----------+");
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Books[0].groupByYear(Books);
            Books[0].countAmount(Books);
        }
    }
}
